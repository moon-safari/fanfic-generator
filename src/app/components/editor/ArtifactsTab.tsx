        ...
        <div className="space-y-4">
          {projectMode === "newsletter" && newsletterProfileDraft && (
            <NewsletterReadinessPanel
              ...
              visibleReadinessChecks={visibleReadinessChecks}
              hiddenReadyCheckCount={hiddenReadyCheckCount}
              nextRecommendedPreset={nextRecommendedPreset}
              showReadinessDetails={showReadinessDetails}
              onToggleReadinessDetails={toggleReadinessDetails}
              onRefreshReadiness={refreshReadiness}
              onOpenInAdapt={onOpenInAdapt}
              currentChapter={currentChapter}
              exportingBundle={exportingBundle}
              canExport={canExportIssueBundle}
              showExportOptions={showExportOptions}
              onToggleExportOptions={() => setShowExportOptions((prev) => !prev)}
              onExportBundle={(mode) => { void exportIssueBundle(mode); }}
          ...
          {projectMode === "newsletter" && newsletterProfileDraft && (
            <NewsletterSetupPanel
              ...
              currentChapter={currentChapter}
              artifacts={artifacts}
              newsletterProfileDraft={newsletterProfileDraft}
              savingNewsletterProfile={savingNewsletterProfile}
              newsletterProfileError={newsletterProfileError}
