...
import { insertCodexEntry } from "../../../../lib/supabase/codex";
import {
...
import type { CreateCodexEntryInput } from "../../../../types/codex";
...
export async function POST(
  ...
  try {
    ...
    const input: CreateCodexEntryInput = {
      name,
      entryType,
      description:
    ...
    const entry = await insertCodexEntry(auth.supabase, storyId, input);
    if (!entry) {
    ...
    console.error("Codex entry create error:", err);
