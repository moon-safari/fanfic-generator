...
import { insertMemoryProgression } from "../../../../../../lib/supabase/memory";
import {
...
import type { CreateMemoryProgressionInput } from "../../../../../../types/memory";
...
export async function POST(
  ...
  try {
    ...
    const input: CreateMemoryProgressionInput = {
      chapterNumber,
      fieldOverrides,
      descriptionOverride:
    ...
    console.error("Memory progression create error:", err);
