...
import type { MemoryFocusRequest } from "../../hooks/useMemoryFocus";
...
interface MemoryPanelProps {
  ...
  focusRequest?: MemoryFocusRequest | null;
  onGenerateMentions?: () => Promise<void>;
  onDismissMentionError?: () => void;
}

function useCompactMemoryLayout() {
...
export default function MemoryPanel({
  ...
  const {
    ...
    acceptSuggestion,
    rejectSuggestion,
  } = useMemorySuggestions(storyId, suggestionRefreshKey);
  ...
  const isCompactViewport = useCompactMemoryLayout();
  ...
  const handleCreateEntry = async (
    input: CreateMemoryEntryInput | UpdateMemoryEntryInput
  ) => {
    const created = await createEntry(input as CreateMemoryEntryInput);
