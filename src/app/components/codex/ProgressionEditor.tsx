...
import type { CodexCustomField, CodexEntry, CodexProgression } from "../../types/codex";
...
interface ProgressionDraft {
  ...
  notes: string;
  fieldOverrides: CodexCustomField[];
}
...
function toDraft(progression: CodexProgression): ProgressionDraft {
  return {
