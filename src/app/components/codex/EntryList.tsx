                  ...
                  {!isCollapsed && (
                    <div className="space-y-1">
                      {group.entries.map((entry) => {
                        const resolved = resolveCodexEntryAtChapter(entry, currentChapter);
...
function getTypeFilters(entries: CodexEntry[], customTypes: CodexCustomType[]) {
...
function matchesEntry(entry: CodexEntry, query: string): boolean {
...
function getTypeColor(entryType: string, customTypes: CodexCustomType[]): string {
