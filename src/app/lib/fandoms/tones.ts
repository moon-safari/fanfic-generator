...
export const TONES: ToneOption[] = [
  ...
  { id: "romance", label: "Romance", subtitle: "Love story, emotional intimacy" },
  { id: "smut", label: "Smut", subtitle: "Explicit sexual content" },
  { id: "hurt-comfort", label: "Hurt/Comfort", subtitle: "Suffering followed by tenderness" },
  { id: "fluff-and-angst", label: "Fluff and Angst", subtitle: "Sweet moments laced with pain" },
  { id: "humor", label: "Humor", subtitle: "Funny, witty, lighthearted" },
  { id: "crack", label: "Crack", subtitle: "Absurd, ridiculous, chaotic" },
  ...
  { id: "pwp", label: "PWP", subtitle: "Plot? What plot? Pure smut" },
  { id: "tooth-rotting-fluff", label: "Tooth-Rotting Fluff", subtitle: "Overwhelmingly sweet and sappy" },
  { id: "emotional-hurt-comfort", label: "Emotional Hurt/Comfort", subtitle: "Psychological pain, then healing" },
  ...
  { id: "suspense", label: "Suspense", subtitle: "Tension, mystery, page-turner" },
];
