...
import {
  deleteMemoryProgression,
  updateMemoryProgression,
} from "../../../../../../../lib/supabase/memory";
import {
  authenticateMemoryStory,
  getMemoryEntryRecord,
  getMemoryProgressionRecord,
  isRouteError,
  isUniqueViolation,
  parseFieldOverrides,
} from "../../../../../shared";
import type { UpdateMemoryProgressionInput } from "../../../../../../../types/memory";
...
export async function PUT(
  ...
  try {
    ...
    const progression = await getMemoryProgressionRecord(
      auth.supabase,
      entryId,
      progressionId
    );
    ...
    const updates: UpdateMemoryProgressionInput = {};
    ...
    const updated = await updateMemoryProgression(
      auth.supabase,
      entryId,
      progressionId,
      updates
    ...
    console.error("Memory progression update error:", err);
...
export async function DELETE(
  ...
  try {
    ...
    const ok = await deleteMemoryProgression(
      auth.supabase,
      entryId,
      progressionId
    );
    ...
    console.error("Memory progression delete error:", err);
    const message =
