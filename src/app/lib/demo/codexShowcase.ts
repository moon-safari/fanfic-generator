...
type CustomTypeSeed = CreateCodexCustomTypeInput;

type EntrySeed = CreateCodexEntryInput & {
  key: string;
};
...
type ProgressionSeed = CreateCodexProgressionInput & {
  entryKey: string;
};
...
export const CODEX_SHOWCASE_TITLE = "Codex Showcase: The Glass Archive";
export const CODEX_SHOWCASE_CUSTOM_FANDOM = "Original Showcase";

export const CODEX_SHOWCASE_STORY = {
  title: CODEX_SHOWCASE_TITLE,
  fandom: "",
  customFandom: CODEX_SHOWCASE_CUSTOM_FANDOM,
...
export const CODEX_SHOWCASE_CHAPTERS: ChapterSeed[] = [
  {
    chapterNumber: 1,
    summary:
...
export const CODEX_SHOWCASE_CUSTOM_TYPES: CustomTypeSeed[] = [
  {
    name: "magic_system",
    color: "#14b8a6",
    icon: "sparkles",
...
export const CODEX_SHOWCASE_ENTRIES: EntrySeed[] = [
  {
    key: "mara_voss",
    name: "Mara Voss",
    entryType: "character",
...
export const CODEX_SHOWCASE_RELATIONSHIPS: RelationshipSeed[] = [
  {
    sourceKey: "mara_voss",
    targetKey: "iven_vale",
...
export const CODEX_SHOWCASE_PROGRESSIONS: ProgressionSeed[] = [
  {
    entryKey: "mara_voss",
    chapterNumber: 2,
    fieldOverrides: {
...
export const CODEX_SHOWCASE_SUGGESTIONS: SuggestionSeed[] = [
  {
    chapterNumber: 3,
...
function fields(...pairs: Array<[string, string]>): CodexCustomField[] {
